...
//Segunda parte, intentar hacer un boton para mandar los resultados por email.

function enviar(){
    var dato = document.getElementById("resultado");
   
    document.getElementById("dato").innerHTML = dato.textContent + "<a href='mailto:froyster@gmail.com'>EMAIL</a>";

}
// Tercera parte, hacer que pueda cambiar el orden de suma a resta y viceversa.
/*
function resta(){
    var cambiarCp = document.getElementById("pequeno");
    if (cambiarCp.onclick == pequeno()){
        cambiarCp.onclick = "restaPequeno()";
        var presentarDato = document.getElementById("dato").innerHTML = cambiarCp.textContent;
    }
    else{
        cambiarCp.onclick = "pequeno()";
        
    }
}
 
function restaPequeno(){
